    ...
    <Background>
        <div class="" id="selected-cards">
            <div class="selected-cards left top">
                ...
                <div :class="tarots[0]['name'].length > 5 ? 'pt-2 w-full text-sm text-center text-white transition-all duration-700 ease' : 'pt-2 w-full text-center text-white transition-all duration-700 ease'" id="left-label">{{ tarots[0]['name'] }}</div>
            </div>
            <div class="selected-cards center top">
                ...
                <div :class="tarots[1]['name'].length > 5 ? 'pt-2 w-full text-sm text-center text-white transition-all duration-700 ease' : 'pt-2 w-full text-center text-white transition-all duration-700 ease'" id="center-label">{{ tarots[1]['name'] }}</div>
            </div>
