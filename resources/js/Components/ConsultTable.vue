            ...
            <tbody>
                <tr v-for="consult in consults.data" :key="consult.id" class="bg-white border-b">
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap flex">
                        <div v-for="card in consult.cards" class="w-[97px] h-[200px] text-gray-900 text-center mx-2">
                    ...
                    <td class="py-4 px-6" v-text="consult.question ? consult.question : '這個人沒有填寫諮詢內容'"
                        :class="consult.question ? 'text-gray-900' : 'text-gray-500'"></td>
                    <td class="py-4 px-6 text-gray-900">
                        {{ consult.reply }}
                    </td>
                    <td class="py-4 px-6">
                        <Link href="#" class="mx-1 font-medium text-blue-600 hover:underline">查看</Link>
